    ...
    static enterInfo() {
     ...
     sideButtons () {
         document.getElementById("deposit").addEventListener("click", function () {
             let transaction = Transaction.deposit(TestUser.checking,TestUser.savings);
         });
         ...
         document.getElementById("withdraw").addEventListener("click", function () {
             let transaction = Transaction.withdraw(TestUser.checking,TestUser.savings);
         });
         document.getElementById("transfer").addEventListener("click", function () {
             let transaction = Transaction.transfer(TestUser.checking,TestUser.savings);
         });
