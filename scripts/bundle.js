	    ...
	    _createClass(main, [{
	        ...
	        value: function clickHandler() {
	            document.getElementById("button").addEventListener("click", function () {
	                new _FileIO2.default.pullInfo("./data/infoBox.csv", main.setInfoBoxData);
	            });
	        }
	    }, {
	        key: "sideButtons",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TestUser = function () {
	    function TestUser(name, pin, callback) {
	        ...
	        new _FileIO2.default.pullInfo("./data/users.csv", TestUser.testData);
	...
	var Transaction = function () {
	    ...
	    _createClass(Transaction, null, [{
	        ...
	        value: function deposit(checking, savings) {
	            ...
	            new _FileIO2.default.pullInfo("./data/infoBox.csv", Transaction.setDepositInfo);
	        }
	    }, {
	        key: "setDepositInfo",
	        ...
	        value: function withdraw(checking, savings) {
	            Transaction.checking = checking;
	            Transaction.savings = savings;
	            new _FileIO2.default.pullInfo("./data/infoBox.csv", Transaction.setWithdrawInfo);
	        }
	    }, {
	        key: "setWithdrawInfo",
